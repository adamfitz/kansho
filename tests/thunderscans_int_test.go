...
func Test_Thunderscans_Chapters_And_Images(t *testing.T) {
	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Minute)
	defer cancel()

	site := &sites.ThunderscansSite{}

	// Stable en-thunderscans.com series
	const mangaURL = "https://en-thunderscans.com/comics/this-assassin-is-honest-and-upright/"
	...
	log.Printf("[TEST] SUCCESS — thunderscans scraper is working")
}