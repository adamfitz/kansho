...
| [Download Queue](specs/download-queue/spec.md) | `specs/download-queue/spec.md` | FIFO queue singleton, single-chapter tasks, task states, cancellation (single + all), CF challenge handling, retry, UI callbacks |
